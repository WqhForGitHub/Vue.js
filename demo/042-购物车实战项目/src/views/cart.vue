<template>
  <div class="view-page view-cart">
    <div class="page-header">
      <h2>购物车</h2>
      <p class="page-desc">管理购物车商品</p>
    </div>
...
export default {
  ...
  computed: {
    ...
    total() {
      return this.$store.state.cart ? this.$store.getters['cart/totalPrice'] : 0
    }
  },
  methods: {
    removeItem(id) { this.$store.dispatch('cart/removeFromCart', id) },
    clearCart() { this.$store.dispatch('cart/clearCart') },
