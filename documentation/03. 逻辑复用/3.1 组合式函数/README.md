...
>注意
>
>此章节假设你已经对组合式 API 有了基本的了解。如果你只学习过选项式 API，你可以使用左侧边栏上方的切换按钮将 API 风格切换为组合式 API 后，重新阅读[响应性基础](https://cn.vuejs.org/guide/essentials/reactivity-fundamentals.html)和[生命周期钩子](https://cn.vuejs.org/guide/essentials/lifecycle.html)两个章。
