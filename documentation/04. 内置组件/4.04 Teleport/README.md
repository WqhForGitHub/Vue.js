...
![](https://front-end-1257950569.cos.ap-guangzhou.myqcloud.com/Vue.js/Vue3/officialDocumentation/28.Teleport/teleport.gif)

我们也可以将 `<Teleport>` 和 [``](https://cn.vuejs.org/guide/built-ins/transition.html) 结合使用来创建一个带动画的模态框。你可以看看[这个示例](https://cn.vuejs.org/examples/#modal)。
...
```vue
<Teleport :disable="isMoblie"></Teleport>
```
